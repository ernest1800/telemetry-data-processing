...
function createChart($app, array $company_stock_data)
{
    ...
    $chart_location = $companyDetailsModel->create_chart($companyDetailsChartModel, $company_stock_data);
}

function validateCompanySymbol($app, array $tainted_parameters): string
{
    $validator = $app->getContainer()->get('validator');
    $validated_company_symbol = $validator->validateCompanySymbol($tainted_parameters['company']);
